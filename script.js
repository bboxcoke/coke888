...
const LANG = {
  cn: {
    ...
    'admin_login_subtitle': 'Admin System Access Only',
    'admin_login_account': 'Admin Account',
    'admin_login_account_placeholder': 'Enter admin account',
    'admin_login_password_placeholder': 'Enter admin password',
    'admin_login_submit': 'Login Admin',
    'admin_login_return': 'Back to User Login',
    'admin_dashboard_title': 'Admin Dashboard',
    'admin_logout': 'Logout',
    'admin_stats_total_users': 'Total Users',
    'admin_stats_total_recharge': 'Total Recharge (MMK)',
    'admin_stats_total_withdraw': 'Total Withdraw (MMK)',
    'admin_stats_online': 'Online Users',
    'admin_tab_dashboard': 'Dashboard',
    'admin_tab_users': 'Users',
    'admin_tab_recharges': 'Recharge Mgmt',
    'admin_tab_withdraws': 'Withdraw Mgmt',
    'admin_tab_promotions': 'Promotions',
    'admin_overview': 'Platform Overview',
    'admin_today_reg': 'Today Registrations',
    'admin_today_recharge': 'Today Recharge',
    'admin_today_withdraw': 'Today Withdraw',
    'admin_active_7d': 'Active Users (7d)',
    'admin_user_list': 'User List',
    'admin_user_search': 'Search username/phone...',
    'admin_recharge_records': 'Recharge Records',
    'admin_withdraw_records': 'Withdraw Records',
    'admin_promo_mgmt': 'Promotion Management',
    'admin_add_promo': 'Add Promotion',
    ...
    'admin_login_subtitle': '后台管理系统专用入口',
    'admin_login_account': '管理员账号',
    'admin_login_account_placeholder': '请输入管理员账号',
    'admin_login_password_placeholder': '请输入管理员密码',
    'admin_login_submit': '登录后台',
    'admin_login_return': '返回前台登录',
    'admin_dashboard_title': '后台管理系统',
    'admin_logout': '退出',
    'admin_stats_total_users': '总用户',
    'admin_stats_total_recharge': '总充值 (MMK)',
    'admin_stats_total_withdraw': '总提现 (MMK)',
    'admin_stats_online': '在线人数',
    'admin_tab_dashboard': '仪表盘',
    'admin_tab_users': '用户管理',
    'admin_tab_recharges': '充值管理',
    'admin_tab_withdraws': '提现管理',
    'admin_tab_promotions': '优惠管理',
    'admin_overview': '平台概览',
    'admin_today_reg': '今日注册',
    'admin_today_recharge': '今日充值',
    'admin_today_withdraw': '今日提现',
    'admin_active_7d': '活跃用户 (7天)',
    'admin_user_list': '用户列表',
    'admin_user_search': '搜索用户名/手机号...',
    'admin_recharge_records': '充值记录',
    'admin_withdraw_records': '提现记录',
    'admin_promo_mgmt': '优惠活动管理',
    'admin_add_promo': '添加活动',
    'admin_loading': '加载中...',
  ...
  mm: {
    ...
    'admin_login': 'စီမံခန့်ခွဲသူအကောင့်ဝင်ရန်',
    ...
    'admin_login_title': 'စီမံခန့်ခွဲသူဝင်ရန်',
    'admin_login_subtitle': 'စီမံခန့်ခွဲမှုစနစ်အတွက်သာ',
    'admin_login_account': 'စီမံခန့်ခွဲသူအကောင့်',
    'admin_login_account_placeholder': 'စီမံခန့်ခွဲသူအကောင့်ထည့်ပါ',
    'admin_login_password_placeholder': 'စကားဝှက်ထည့်ပါ',
    'admin_login_submit': 'စီမံခန့်ခွဲသူဝင်ရန်',
    'admin_login_return': 'အသုံးပြုသူအကောင့်ဝင်ရန်သို့',
    'admin_dashboard_title': 'စီမံခန့်ခွဲမှုအကန့်',
    'admin_logout': 'ထွက်ရန်',
    'admin_stats_total_users': 'စုစုပေါင်းအသုံးပြုသူ',
    'admin_stats_total_recharge': 'စုစုပေါင်းငွေသွင်း (MMK)',
    'admin_stats_total_withdraw': 'စုစုပေါင်းငွေထုတ် (MMK)',
    'admin_stats_online': 'အွန်လိုင်းရှိသူများ',
    'admin_tab_dashboard': 'ဒက်ရှ်ဘုတ်',
    'admin_tab_users': 'အသုံးပြုသူများ',
    'admin_tab_recharges': 'ငွေသွင်းစီမံ',
    'admin_tab_withdraws': 'ငွေထုတ်စီမံ',
    'admin_tab_promotions': 'ပရိုမိုးရှင်းများ',
    'admin_overview': 'ပလက်ဖောင်းခြုံငုံ',
    'admin_today_reg': 'ယနေ့စာရင်းသွင်း',
    'admin_today_recharge': 'ယနေ့ငွေသွင်း',
    'admin_today_withdraw': 'ယနေ့ငွေထုတ်',
    'admin_active_7d': '၇ရက်အတွင်းလှုပ်ရှားမှု',
    'admin_user_list': 'အသုံးပြုသူစာရင်း',
    'admin_user_search': 'အသုံးပြုသူအမည်/ဖုန်းရှာဖွေ...',
    'admin_recharge_records': 'ငွေသွင်းမှတ်တမ်း',
    'admin_withdraw_records': 'ငွေထုတ်မှတ်တမ်း',
    'admin_promo_mgmt': 'ပရိုမိုးရှင်းစီမံခန့်ခွဲမှု',
    'admin_add_promo': 'ပရိုမိုးရှင်းထည့်ရန်',
    'admin_loading': 'ဝန်ဆွဲတင်နေသည်...',
    'admin_all_status': 'အားလုံးအခြေအနေ',
    'admin_no_data': 'ဒေတာမရှိပါ',
  ...
  th: {
    ...
    'admin_login_subtitle': 'สำหรับผู้ดูแลระบบเท่านั้น',
    'admin_login_account': 'บัญชีผู้ดูแล',
    'admin_login_account_placeholder': 'กรุณากรอกบัญชีผู้ดูแล',
    'admin_login_password_placeholder': 'กรุณากรอกรหัสผ่าน',
    'admin_login_submit': 'เข้าสู่ระบบ',
    'admin_login_return': 'กลับไปหน้าเข้าสู่ระบบ',
    'admin_dashboard_title': 'แดชบอร์ดผู้ดูแล',
    'admin_logout': 'ออกจากระบบ',
    'admin_stats_total_users': 'ผู้ใช้ทั้งหมด',
    'admin_stats_total_recharge': 'ยอดฝากรวม (MMK)',
    'admin_stats_total_withdraw': 'ยอดถอนรวม (MMK)',
    'admin_stats_online': 'ผู้ใช้ออนไลน์',
    'admin_tab_dashboard': 'แดชบอร์ด',
    'admin_tab_users': 'จัดการผู้ใช้',
    'admin_tab_recharges': 'จัดการฝาก',
    'admin_tab_withdraws': 'จัดการถอน',
    'admin_tab_promotions': 'จัดการโปรโมชั่น',
    'admin_overview': 'ภาพรวมแพลตฟอร์ม',
    'admin_today_reg': 'สมัครวันนี้',
    'admin_today_recharge': 'ฝากวันนี้',
    'admin_today_withdraw': 'ถอนวันนี้',
    'admin_active_7d': 'ใช้งาน (7 วัน)',
    'admin_user_list': 'รายชื่อผู้ใช้',
    'admin_user_search': 'ค้นหา...',
    'admin_recharge_records': 'ประวัติฝาก',
    'admin_withdraw_records': 'ประวัติถอน',
    'admin_promo_mgmt': 'จัดการโปรโมชั่น',
    'admin_add_promo': 'เพิ่มโปรโมชั่น',
    'admin_loading': 'กำลังโหลด...',
    'admin_all_status': 'สถานะทั้งหมด',
...
function adminSearchUsers() {
  ...
  fetch('/api/admin/users' + (search ? `?search=${encodeURIComponent(search)}` : ''), { headers: getAdminHeaders() })
    .then(r => r.json())
    .then(data => {
      ...
      container.innerHTML = users.map(u => `
        <tr>
          ...
          <td>${u.username}</td>
          <td>${u.phone || '-'}</td>
          <td>${adminFormatBalance(u.balance || 0)} MMK</td>
          <td><span class="admin-status ${u.status === '冻结' ? 'admin-status-rejected' : u.status === 'VIP' ? 'admin-status-approved' : 'admin-status-pending'}">${u.status || '正常'}</span></td>
          <td>${u.regTime || u.created_at || '-'}</td>
        </tr>
      `).join('');
    })
...
function adminFilterRecharges() {
  const status = document.getElementById('rechargeStatusFilter')?.value || '';
  const container = document.getElementById('rechargesTableBody');
  if (!container) return;
  
  fetch('/api/admin/deposits' + (status ? `?status=${encodeURIComponent(status)}` : ''), { headers: getAdminHeaders() })
    .then(r => r.json())
    .then(data => {
      const deposits = data.deposits || [];
      container.innerHTML = deposits.map((d, i) => {
        const statusClass = d.status === '已完成' ? 'admin-status-approved' : d.status === '待处理' ? 'admin-status-pending' : 'admin-status-rejected';
        return `
          <tr>
            <td>${d.id}</td>
            <td>${d.username}</td>
            <td>${adminFormatBalance(d.amount)} MMK</td>
            <td>${d.method || '-'}</td>
            <td>${d.time || d.created_at || '-'}</td>
            <td><span class="admin-status ${statusClass}">${d.status || '待处理'}</span></td>
            <td class="admin-actions">
              ${d.status === '待处理' ? `
                <button class="admin-btn admin-btn-approve" onclick="adminApprove(${d.id}, 'deposit')">通过</button>
                <button class="admin-btn admin-btn-reject" onclick="adminReject(${d.id}, 'deposit')">拒绝</button>
              ` : '-'}
            </td>
          </tr>
        `;
    ...
    .catch(() => showToast('筛选失败'));
}

function adminFilterWithdraws() {
  const status = document.getElementById('withdrawStatusFilter')?.value || '';
  const container = document.getElementById('withdrawsTableBody');
  if (!container) return;
  
  fetch('/api/admin/withdrawals' + (status ? `?status=${encodeURIComponent(status)}` : ''), { headers: getAdminHeaders() })
    .then(r => r.json())
    .then(data => {
      const withdraws = data.withdrawals || [];
      container.innerHTML = withdraws.map((w, i) => {
        const statusClass = w.status === '已完成' ? 'admin-status-approved' : w.status === '待处理' ? 'admin-status-pending' : 'admin-status-rejected';
        return `
          <tr>
            <td>${w.id}</td>
            <td>${w.username}</td>
            <td>${adminFormatBalance(w.amount)} MMK</td>
            <td>${w.method || '-'}</td>
            <td>${w.account || '-'}</td>
            <td>${w.time || w.created_at || '-'}</td>
            <td><span class="admin-status ${statusClass}">${w.status || '待处理'}</span></td>
            <td class="admin-actions">
              ${w.status === '待处理' ? `
                <button class="admin-btn admin-btn-approve" onclick="adminApprove(${w.id}, 'withdraw')">通过</button>
                <button class="admin-btn admin-btn-reject" onclick="adminReject(${w.id}, 'withdraw')">拒绝</button>
              ` : '-'}
            </td>
          </tr>
        `;
...
async function renderAdminDashboard() {
  try {
    ...
    if (!res.ok) { showToast('获取统计数据失败'); return; }
    const data = await res.json();
    const stats = data.stats || {};

    const statIds = {
      statTotalUsers: String(stats.totalUsers ?? '0'),
      statTotalRecharge: adminFormatBalance(stats.totalDeposits ?? 0),
      statTotalWithdraw: adminFormatBalance(stats.totalWithdrawals ?? 0),
      statOnlineUsers: String(stats.onlineUsers ?? '0')
    };
    Object.keys(statIds).forEach(id => {
      const el = document.getElementById(id);
      if (el) el.textContent = statIds[id];
    });

    const metrics = {
      dashboardTodayReg: String(stats.todayReg ?? stats.todayRegistrations ?? '0'),
      dashboardTodayRecharge: adminFormatBalance(stats.todayDep ?? stats.todayDeposits ?? 0) + ' MMK',
      dashboardTodayWithdraw: adminFormatBalance(stats.todayWit ?? stats.todayWithdrawals ?? 0) + ' MMK',
      dashboardActive7d: String(stats.active7 ?? stats.activeUsers7d ?? '0')
    };
    ...
    showToast('加载统计数据失败: ' + err.message);
  }
}
...
function switchAdminTab(tabName) {
  ...
  // Render content based on tab (async)
  switch (tabName) {
    case 'dashboard':
      renderAdminDashboard();
      break;
...
async function renderAdminUsers() {
  ...
  try {
    ...
    if (!res.ok) { showToast('获取用户列表失败'); return; }
    const data = await res.json();
    const users = data.users || [];
...
async function renderAdminDeposits() {
  ...
  try {
    ...
    if (!res.ok) { showToast('获取充值列表失败'); return; }
    const data = await res.json();
    const deposits = data.deposits || [];
    ...
    showToast('加载充值列表失败: ' + err.message);
  }
}

async function renderAdminWithdraws() {
  const container = document.getElementById('withdrawsTableBody');
  if (!container) return;

  try {
    const res = await fetch('/api/admin/withdrawals', { headers: getAdminHeaders() });
    if (!res.ok) { showToast('获取提现列表失败'); return; }
    const data = await res.json();
    const withdraws = data.withdrawals || [];
    ...
    showToast('加载提现列表失败: ' + err.message);
  }
}

async function renderAdminPromotions() {
  const container = document.getElementById('promotionsTableBody');
  if (!container) return;
  
  try {
    const res = await fetch('/api/admin/promotions', { headers: getAdminHeaders() });
    if (!res.ok) { showToast('获取优惠列表失败'); return; }
    const data = await res.json();
    ...
    container.innerHTML = promotions.map((p, i) => `
      <tr>
        ...
        <td><span class="admin-status ${p.status === '进行中' ? 'admin-status-approved' : 'admin-status-pending'}">${p.status || '-'}</span></td>
        <td>${p.start_date || '-'}</td>
        <td>${p.end_date || '-'}</td>
        <td>
          <button class="admin-btn admin-btn-approve" style="font-size:12px;padding:2px 8px" onclick="showToast('优惠活动编辑功能即将上线')">编辑</button>
          <button class="admin-btn admin-btn-reject" style="font-size:12px;padding:2px 8px" onclick="showToast('确定要删除此活动？')">删除</button>
        </td>
      </tr>
    `).join('');
  } catch (err) {
    showToast('加载优惠列表失败: ' + err.message);
  }
}

async function adminApprove(id, type) {
  const typeLabel = type === 'deposit' ? '充值' : '提现';
  try {
    ...
    showToast(`✅ 已通过 #${id} ${typeLabel}申请`);
    // Refresh current tab
    const activeTab = document.querySelector('.admin-tab.active');
    if (activeTab) switchAdminTab(activeTab.getAttribute('data-tab'));
  } catch (err) {
